    ...
    <Navbar expand="lg" className="header sticky">
      ...
      <Navbar.Collapse>
        <Nav className="header-left">
          ...
          {/* Projects Link */}
          <Nav.Link as={NavLink} to="/projects" className={pathName === "/projects" ? "header-link-active" : "header-link"}>PROJECTS</Nav.Link>
          {/* Blog Link */}
          <Nav.Link as={NavLink} to="/blog" className={pathName === "/blog" ? "header-link-active" : "header-link"}>BLOG</Nav.Link>
          {/* Contact Link */}
